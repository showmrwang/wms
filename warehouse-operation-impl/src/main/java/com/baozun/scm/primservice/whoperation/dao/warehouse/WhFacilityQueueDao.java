...
public interface WhFacilityQueueDao extends BaseDao<WhFacilityQueue, Long> {
    ...
    Pagination<WhFacilityQueue> findListByQueryMapWithPage(Page page, Sort[] sorts, Map<String, Object> params);

    @QueryPage("queryCount")
    Pagination<WhFacilityQueue> query(Page page, Sort[] sorts, QueryCondition cond);

    List<WhFacilityQueue> query(QueryCondition cond);
