...
public interface WarehouseDao extends BaseDao<Warehouse, Long> {
    ...
    Pagination<Warehouse> findListByQueryMapWithPage(Page page, Sort[] sorts, Map<String, Object> params);

    @CommonQuery
    int saveOrUpdate(Warehouse o);

    @CommonQuery
    int saveOrUpdateByVersion(Warehouse o);

    WarehouseCommand checkNameOrCode(@Param("name") String name, @Param("code") String code);

    @QueryPage("findListCountByQueryMapExt")
    Pagination<WarehouseCommand> findListByQueryMapWithPageExt(Page page, Sort[] sorts, Map<String, Object> params);
