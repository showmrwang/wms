...
public interface WhLocationSkuVolumeDao extends BaseDao<WhLocationSkuVolume, Long> {
     ...
     * @return
     */
    WhLocationSkuVolumeCommand findFacilityLocSkuVolumeByLocSku(@Param("facilityId") Long facilityId, @Param("locationCode") String locationCode, @Param("skuId") Long skuId, @Param("ouId") Long ouId);
