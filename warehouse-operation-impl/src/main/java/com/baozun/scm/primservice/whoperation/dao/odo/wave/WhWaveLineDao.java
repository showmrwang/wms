...
public interface WhWaveLineDao extends BaseDao<WhWaveLine, Long> {
     ...
     * @param ouId
     */
    int removeWaveLineWholeByOdoIdList(@Param("waveId") Long waveId, @Param("odoIdList") List<Long> odoIdList, @Param("ouId") Long ouId);
    ...
    List<Long> findNoRuleOdoIdListByWaveId(@Param("waveId") Long waveId, @Param("ouId") Long ouId);

    List<String> findOdocodeByWaveId(@Param("waveId") Long id, @Param("ouId") Long ouId);
