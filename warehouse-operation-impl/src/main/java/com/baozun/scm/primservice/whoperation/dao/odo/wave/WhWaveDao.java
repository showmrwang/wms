...
public interface WhWaveDao extends BaseDao<WhWave, Long> {
    ...
    List<SoftAllocationCommand> getSkuInvTotalQty(@Param("waveId") Long waveId, @Param("ouId") Long ouId);

    List<SoftAllocationCommand> getSkuInvOccupiedQty(@Param("waveId") Long waveId, @Param("ouId") Long ouId);
