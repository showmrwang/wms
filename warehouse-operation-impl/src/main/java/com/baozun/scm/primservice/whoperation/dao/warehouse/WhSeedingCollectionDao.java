...
public interface WhSeedingCollectionDao extends BaseDao<WhSeedingCollection, Long> {
     ...
     * @return
     */
    public List<WhSeedingCollectionCommand> getSeedingCollectionByFacilityId(@Param("facilityId") Long facilityId, @Param("ouId") Long ouId, @Param("collectionStatus") Integer collectionStatus);
