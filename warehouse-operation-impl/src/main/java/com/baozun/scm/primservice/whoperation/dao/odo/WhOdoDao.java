...
public interface WhOdoDao extends BaseDao<WhOdo, Long> {
    ...
    List<WhOdo> findOdoListByWaveCode(@Param("waveCode") String waveCode, @Param("ouId") Long ouId);
    ...
    int updateOdoByCancel(@Param("odoId") Long odoId, @Param("reason") String reason, @Param("ouId") Long ouId);
