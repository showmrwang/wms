...
public interface ContainerAssistDao extends BaseDao<ContainerAssist, Long> {
    ...
    Pagination<ContainerAssist> findListByQueryMapWithPage(Page page, Sort[] sorts, Map<String, Object> params);

    @QueryPage("queryCount")
    Pagination<ContainerAssist> query(Page page, Sort[] sorts, QueryCondition cond);

    List<ContainerAssist> query(QueryCondition cond);
