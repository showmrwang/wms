...
public class OutBoundBoxCompute {
     ...
     * @return 累计放入出库箱商品总体积
     */
    public static Double obbCompute(List<WaveLineCommand> waveLineList, Map<String, WhOdoOutBoundBox> oobbMap, Double boxTotalVolume, Long outBoundBoxType, Long containerId, String outbounxboxTypeCode) {
        ...
        // 调整波次明细对应数量
        revisionWaveLineQty(waveLineList, oobbMap, solveResult, outBoundBoxType, containerId, outbounxboxTypeCode);
     ...
     * @param waveLineList
     */
    private static void revisionWaveLineQty(List<WaveLineCommand> waveLineList, Map<String, WhOdoOutBoundBox> oobbMap, Map<Long, Integer> solveResult, Long outBoundBoxType, Long containerId, String outbounxboxTypeCode) {
