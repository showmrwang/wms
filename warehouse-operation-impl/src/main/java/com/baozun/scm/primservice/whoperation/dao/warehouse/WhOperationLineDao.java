...
public interface WhOperationLineDao extends BaseDao<WhOperationLine,Long>{
     ...
     * @return
     */
    List<WhOperationLineCommand> findOperationLineByLocationId(@Param("ouId") Long ouId,@Param("locationId") Long locationId,@Param("replenishmentCode") String replenishmentCode);
     ...
     * @return
     */
    public int findInventoryCountsByInsideContainerId(@Param("ouId") Long ouId, @Param("fromInsideContainerId") Long fromInsideContainerId,@Param("operationId") Long operationId);
