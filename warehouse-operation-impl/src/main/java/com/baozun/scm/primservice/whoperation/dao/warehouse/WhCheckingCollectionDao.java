...
public interface WhCheckingCollectionDao extends BaseDao<WhCheckingCollection, Long> {
    ...
    Pagination<WhCheckingCollection> findListByQueryMapWithPage(Page page, Sort[] sorts, Map<String, Object> params);

    @QueryPage("queryCount")
    Pagination<WhCheckingCollection> query(Page page, Sort[] sorts, QueryCondition cond);
