 ...
 *
 */
public class WhInboundConfirmCommand extends BaseCommand {

	private static final long serialVersionUID = 2993917694571388118L;
	...
	public WhInboundConfirmCommand() {
	}

	public WhInboundConfirmCommand(Long id) {
		this.id = id;
	}
	...
	public List<WhInboundLineConfirmCommand> getWhInboundLineConfirmList() {
		return whInboundLineConfirmList;
	}
