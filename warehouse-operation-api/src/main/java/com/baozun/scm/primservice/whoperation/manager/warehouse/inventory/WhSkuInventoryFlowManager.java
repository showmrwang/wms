...
public interface WhSkuInventoryFlowManager extends BaseManager {
     ...
     * @return
     */
    List<WmsSkuInventoryFlow> findWmsSkuInventoryFlowByCreateTime(String beginTime, String endTime, Integer start, Integer pageSize, Long ouid, String customerCode);
}
