...
public class BiPoLineCommand extends BaseCommand {

    /**
     * 
     */
    private static final long serialVersionUID = -2195773269922510651L;
    /** 主键ID */
    private Long id;
    /** PO单ID */
    private Long poId;
    ...
    public void setValidDateUomName(String validDateUomName) {
        this.validDateUomName = validDateUomName;
    }
