 ...
 *
 */
public class WhInboundInvLineConfirmCommand extends BaseCommand {

	private static final long serialVersionUID = 6609584996483589081L;
	...
	/** 收货SN反馈信息 */
	private List<WhInboundSnLineConfirmCommand> whInBoundSnLineConfirmCommandList;

	public WhInboundInvLineConfirmCommand() {}

	public WhInboundInvLineConfirmCommand(Long id) {
		this.id = id;
	}
	...
	public List<WhInboundSnLineConfirmCommand> getWhInBoundSnLineConfirmCommandList() {
		return whInBoundSnLineConfirmCommandList;
	}

	public void setWhInBoundSnLineConfirmCommandList(
			List<WhInboundSnLineConfirmCommand> whInBoundSnLineConfirmCommandList) {
		this.whInBoundSnLineConfirmCommandList = whInBoundSnLineConfirmCommandList;
	}
