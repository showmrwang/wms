...
public final class CacheKeyConstant {
    ...
    /** 出库箱创建 小车类二级容器缓存前缀 */
    public static final String CREATE_OUTBOUND_CARTON_TROLLEY_LIST_ORDER_BY_GRID_NUM_DESC_PREFIX = "CREATE-OUTBOUND-CARTON-TROLLEY-LIST-ORDER-BY-GRID-NUM-DESC-";
    /** 出库箱创建 周转箱类二级容器缓存前缀 */
