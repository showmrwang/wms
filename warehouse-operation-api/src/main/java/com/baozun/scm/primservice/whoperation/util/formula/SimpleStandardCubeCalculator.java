 ...
 *
 */
public class SimpleStandardCubeCalculator {
    /**
     * 简单立方体计算器
     */
    ...
    public SimpleStandardCubeCalculator() {
        preInit();
    }

    public SimpleStandardCubeCalculator(Double _x, Double _y, Double _z, String _uom, Double availability) {
        preInit();
