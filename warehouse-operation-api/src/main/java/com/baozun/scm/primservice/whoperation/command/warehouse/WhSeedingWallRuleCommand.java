 ...
 *
 */
public class WhSeedingWallRuleCommand extends BaseCommand {
	
	private static final long serialVersionUID = -7621966069437315494L;
	...
	public WhSeedingWallRuleCommand(){}

	public WhSeedingWallRuleCommand(Long id){
		this.id = id;
	}
