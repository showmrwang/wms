 ...
 *
 */
public class WhFacilityPathCommand extends BaseCommand {
	...
	/** 从区域类型名称 */
	private String fromAreaTypeName;
	/** 到区域类型名称 */
	private String toAreaTypeName;

	public WhFacilityPathCommand(){}

	public WhFacilityPathCommand(Long id){
		this.id = id;
	}
	...
	public String getFromAreaTypeName() {
		return fromAreaTypeName;
	}

	public void setFromAreaTypeName(String fromAreaTypeName) {
		this.fromAreaTypeName = fromAreaTypeName;
	}

	public String getToAreaTypeName() {
		return toAreaTypeName;
	}

	public void setToAreaTypeName(String toAreaTypeName) {
		this.toAreaTypeName = toAreaTypeName;
	}
}
