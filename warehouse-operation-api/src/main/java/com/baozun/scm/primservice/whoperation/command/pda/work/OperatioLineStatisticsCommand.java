...
public class OperatioLineStatisticsCommand extends BaseCommand {
    ...
    private Map<Integer,Long> latticeLoc = new HashMap<Integer,Long>();   //货格对应的库位号
    
    private  Map<String,Map<String,Long>> latticeSkuAttrIdsQty = new HashMap<String,Map<String,Long>>();   //货格+库位对应唯一sku对应的数量(散装的)
    
    private  Map<String,Map<Long,Map<String,Long>>> latticeInsideSkuAttrIdsQty = new HashMap<String,Map<Long,Map<String,Long>>>();   //货格+库位对应唯一sku对应的数量(有货箱的)
    ...
    public Map<Integer, Long> getLatticeLoc() {
        return latticeLoc;
    }

    public void setLatticeLoc(Map<Integer, Long> latticeLoc) {
