...
public class OutboundBoxRuleCommand extends BaseCommand {

    private static final long serialVersionUID = -3372764196973485804L;
    ...
    /** 分拣排序条件列表 */
    private List<OutboundBoxSortCommand> outboundBoxSortCommandList;
    /** 规则测试结果 */
    ...
    public List<OutboundBoxSortCommand> getOutboundBoxSortCommandList() {
        return outboundBoxSortCommandList;
    }

    public void setOutboundBoxSortCommandList(List<OutboundBoxSortCommand> outboundBoxSortCommandList) {
        this.outboundBoxSortCommandList = outboundBoxSortCommandList;
    }
