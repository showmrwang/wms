 ...
 *
 */
public class WhPoTransportMgmt extends BaseModel {
	
	private static final long serialVersionUID = 2527054979690792982L;
	...
	public WhPoTransportMgmt() {}

	public WhPoTransportMgmt(Long id) {
		this.id = id;
	}
