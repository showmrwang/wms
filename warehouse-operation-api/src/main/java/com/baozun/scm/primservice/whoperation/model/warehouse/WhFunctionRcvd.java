 ...
 * 
 */
public class WhFunctionRcvd extends BaseModel {


    private static final long serialVersionUID = 6839913285984754406L;
    ...
    /** 按照标准装箱提示收货 */
    private Boolean normIncPointoutRcvd = false;
    /** 是否限定唯一库存类型 */
    private Boolean isLimitUniqueInvType = false;
    /** 是否限定唯一库存状态 */
    private Boolean isLimitUniqueInvStatus = false;
    /** 是否限定唯一库存属性1 */
    private Boolean isLimitUniqueInvAttr1 = false;
    /** 是否限定唯一库存属性2 */
    private Boolean isLimitUniqueInvAttr2 = false;
    /** 是否限定唯一库存属性3 */
    private Boolean isLimitUniqueInvAttr3 = false;
    /** 是否限定唯一库存属性4 */
    private Boolean isLimitUniqueInvAttr4 = false;
    /** 是否限定唯一库存属性5 */
    private Boolean isLimitUniqueInvAttr5 = false;
    /** 是否限定唯一原产地 */
    private Boolean isLimitUniquePlaceoforigin = false;
    /** 是否限定唯一批次号 */
    private Boolean isLimitUniqueBatch = false;
    /** 是否限定唯一生产日期 */
    private Boolean isLimitUniqueDateOfManufacture = false;
    /** 是否限定唯一失效日期 */
    private Boolean isLimitUniqueExpiryDate = false;
    /** 是否支持混放SKU */
    private Boolean isMixingSku = false;
    /** 对应组织ID */
    private Long ouId;
    /** 已知库存属性的ASN是否需要提示用户 */
    private Boolean isInvattrAsnPointoutUser = false;
    /** 库存属性差异是否允许收货 */
    private Boolean isInvattrDiscrepancyAllowrcvd = false;
    /** CASELEVEL是否需要扫描SKU */
    private Boolean isCaselevelScanSku = false;
