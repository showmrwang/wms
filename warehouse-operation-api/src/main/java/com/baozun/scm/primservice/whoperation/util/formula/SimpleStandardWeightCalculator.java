 ...
 *
 */
public class SimpleStandardWeightCalculator {
    /**
     * 简单重量计算器
     */
    ...
    public SimpleStandardWeightCalculator() {
        preInit();
    }

    public SimpleStandardWeightCalculator(Double _weight, String _uom) {
        preInit();
        setInit(true);
        init(_weight, _uom);
    }
    ...
    public static void setUomSize(int uomSize) {
        SimpleStandardWeightCalculator.uomSize = uomSize;
    }
