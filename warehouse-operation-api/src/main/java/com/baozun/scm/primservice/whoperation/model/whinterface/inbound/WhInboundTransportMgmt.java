 ...
 *
 */
public class WhInboundTransportMgmt extends BaseModel {

	private static final long serialVersionUID = 889447332417674972L;
	...
	public WhInboundTransportMgmt() {
	}

	public WhInboundTransportMgmt(Long id) {
		this.id = id;
	}
