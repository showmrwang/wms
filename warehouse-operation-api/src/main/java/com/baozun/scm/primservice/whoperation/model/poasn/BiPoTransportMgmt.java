 ...
 *
 */
public class BiPoTransportMgmt extends BaseModel {

	private static final long serialVersionUID = -3687963994281662032L;
	...
	public BiPoTransportMgmt() {}

	public BiPoTransportMgmt(Long id) {
		this.id = id;
	}
