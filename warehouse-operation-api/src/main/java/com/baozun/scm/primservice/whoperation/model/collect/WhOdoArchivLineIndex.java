 ...
 *
 */
public class WhOdoArchivLineIndex extends BaseModel {

	private static final long serialVersionUID = 6989702809883887132L;
	...
	public WhOdoArchivLineIndex() {}

	public WhOdoArchivLineIndex(Long id) {
		this.id = id;
	}
