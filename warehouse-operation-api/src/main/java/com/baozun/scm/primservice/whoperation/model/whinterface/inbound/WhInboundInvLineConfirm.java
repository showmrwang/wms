...
public class WhInboundInvLineConfirm extends BaseModel {
    ...
    /** 入库反馈SN/残次信息 */
    private List<WhInboundSnLineConfirm> whInboundSnLineConfirms;
    ...
    public List<WhInboundSnLineConfirm> getWhInboundSnLineConfirms() {
        return whInboundSnLineConfirms;
    }

    public void setWhInboundSnLineConfirms(List<WhInboundSnLineConfirm> whInboundSnLineConfirms) {
        this.whInboundSnLineConfirms = whInboundSnLineConfirms;
    }
