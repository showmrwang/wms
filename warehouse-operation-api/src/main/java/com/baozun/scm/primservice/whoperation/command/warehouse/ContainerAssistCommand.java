 ...
 *
 */
public class ContainerAssistCommand extends BaseModel {

    private static final long serialVersionUID = -7517828536652543391L;
 // alias
    ...
    public ContainerAssistCommand(java.lang.Long id) {
        this.id = id;
    }
