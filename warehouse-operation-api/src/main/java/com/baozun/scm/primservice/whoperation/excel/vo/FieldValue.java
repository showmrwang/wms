package com.baozun.scm.primservice.whoperation.excel.vo;
...
public class FieldValue {
	...
	/** 为null时错误编码 */
	private String nullErrorCode;
	/** 正则表达式,导入有效 */
	private String regex;
	/** 正则表达式不通过时,错误提示信息 */
	private String regexErrMsg;
	/** 正则表达式不通过时,错误提示信息编码 */
	private String regexErrCode;

	// 导出时生效
	/**
	 * cell的宽度,此属性不受enableStyle影响,如自己把数值写的过大,看org.apache.poi.ss.usermodel.Sheet.
	 * setColumnWidth(int, int)解决
	 */
	...
	/*
	 * 其他配置项: 与Excel导入导出无关,或许在自定义转换器时利用该参数可以更灵活配置一些其他信息,
	...
	public String getRegexErrCode() {
		return regexErrCode;
	}

	public void setRegexErrCode(String regexErrCode) {
		this.regexErrCode = regexErrCode;
	}

	public String getNullErrorCode() {
		return nullErrorCode;
	}

	public void setNullErrorCode(String nullErrorCode) {
